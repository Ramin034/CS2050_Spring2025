...
public class CollectionSortBooksLinkedList
{
	...
	public static void main(String[] args)
	{
		...
		// add code
		System.out.println("Books sorted by author the title");
        ...
        while(!signOutQueue.isEmpty()) {
        	...
        	System.out.println("Books signed out " + signOutQueue.remove());
      ...
      //Step 10: Use HashMap to organize book by title
    	...
    	System.out.println("Enter book title that you are looking for");
